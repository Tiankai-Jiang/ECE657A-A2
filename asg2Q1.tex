...
\centering
\subfloat[]{\includegraphics[width=0.48\textwidth]{Q1_all_features_color.png}}
...
\captionsetup[subfigure]{labelformat=empty}
\centering
\subfloat[]{\includegraphics[width=0.48\textwidth]{Q1_BestParam_color.png}}
\subfloat[] {\includegraphics[width=0.48\textwidth]{Q1_BestParam_quality.png}}
\end{figure}
\noindent
...
\captionsetup[subfigure]{labelformat=empty}
\centering
\subfloat[]{\includegraphics[width=0.48\textwidth]{Q1_PCA_ifNormalized}}
\subfloat[] {\includegraphics[width=0.48\textwidth]{Q1_LDA_ifNormalized.png}}
\end{figure}
\noindent
...
\captionsetup[subfigure]{labelformat=empty}
\centering
\subfloat[]{\includegraphics[width=0.48\textwidth]{Q1_PCA_Scatter_color.png}}
\subfloat[] {\includegraphics[width=0.48\textwidth]{Q1_LDA_Scatter_color.png}}
\end{figure}
% \vspace*{-2.0cm}
\begin{figure}[H]
\captionsetup[subfigure]{labelformat=empty}
\centering
\subfloat[]{\includegraphics[width=0.48\textwidth]{Q1_PCA_Scatter_quality.png}}
\subfloat[] {\includegraphics[width=0.48\textwidth]{Q1_LDA_Scatter_quality.png}}
\end{figure}
\noindent
